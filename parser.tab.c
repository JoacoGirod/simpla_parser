...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DIVISION = 3,                   /* DIVISION  */
  YYSYMBOL_ARTICLE = 4,                    /* ARTICLE  */
  YYSYMBOL_SUBARTICLE = 5,                 /* SUBARTICLE  */
  YYSYMBOL_BODY = 6,                       /* BODY  */
  YYSYMBOL_YYACCEPT = 7,                   /* $accept  */
  YYSYMBOL_input = 8,                      /* input  */
  YYSYMBOL_token_line = 9                  /* token_line  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "DIVISION", "ARTICLE",
  "SUBARTICLE", "BODY", "$accept", "input", "token_line", YY_NULLPTR
};
